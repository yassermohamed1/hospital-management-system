...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const selectAll = document.querySelector('[name="select_all"]');
        const checkboxes = document.querySelectorAll('[name="delete_select"]');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        btnDeleteAll.addEventListener("click", function() {
            ...
            const checkboxes = document.querySelectorAll(
                "#example input[name='delete_select']:checked"
            );
            ...
            if (selected.length > 0) {
                ...
                // فتح المودال (Bootstrap 5)
                const modal = new bootstrap.Modal(
                    document.getElementById('delete_select')
                );
                modal.show();

                // وضع القيم داخل input hidden
                document.getElementById("delete_select_id").value = selected.join(",");
